        ...
        @if (count($kitchenOrderPrintItems) != 0)
            ...
            <table
                ...
                <thead style="font-weight:bold">
                    <tr>
                        <th style="width:150px">{{ now()->format('Y-m-d') }}, {{ now()->format('h:i A') }} (
                            {{ $order['order_id'] }})</th>
                    </tr>
                </thead>
            </table>
            <table
                ...
                <thead style="font-weight:bold">
                    <tr>
                        <th style="width:150px">{{ $order['floor_name'] }}, {{ $order['table_name'] }},
                            {{ $order['table_order_number'] }}</th>
                    </tr>
                </thead>
            </table>
            <table
    ...
    <form action="">
        @foreach ($groupedItems as $category)
            @if (count($category['items']) > 0)
                <table class="table table-borderless" style="font-size:13px; width:100%; margin:0;">
                    <thead>
                        <tr>
