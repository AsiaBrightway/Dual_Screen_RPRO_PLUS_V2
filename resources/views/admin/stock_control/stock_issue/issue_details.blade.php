...
@section('content')
        ...
        <div class="home-content">
            <div class="row pb-3 align-items-center" style="color:#512DA8; font-weight:bold">
                <div class="col-12 col-md-7">
                    <label>Stock Issue Details</label>
                </div>
                <div class="col-12 col-md-5 text-md-end text-start mt-3 mt-md-0">
                    <a href="{{ route('stockControl#stock_issue#issueListPage', ['issueDate' => $issueDate]) }}">
                        <button class="btn btn-warning text-white customBtn-exit" id="btn_Exit"><i class="fa-solid fa-circle-left"
                                style="padding-right: 5px"></i>Back</button></a>
                </div>
            </div>
            <div id="issue_info_label" class="row align-items-center bg-white">
                <div class="col-10">
                    <label><i class="fa-regular fa-newspaper" style="padding-left:5px; padding-right: 12px"></i>
                        Issue Voucher Info
                    </label>
                </div>
                    ...
                    <div class="issue_info_left col-5">
                        <div class="row">
                            <div class="col-4 mb-3">
                                <label class="form-label">Issue Voucher No</label>
                            </div>
                            <div class="col-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input class="form-control" type="text" id="issue_type" name="issue_type"
                                    value="{{ $issueTypeName }}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="issue_info_right col-5 offset-2">
                        <div class="row">
                            <div class="col-4 col-sm-3 col-xxl-2 mb-3">
                                <label class="form-label">Remark</label>
                            </div>
                            <div class="col-8 col-sm-9 col-xxl-10">
                                <textarea readonly class="form-control" id="remark" name="remark" rows="3" value="{{ $selectedStockIssue[0]['remark'] }}">{{ $selectedStockIssue[0]['remark'] }}</textarea>
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{ asset('script/issue_details_script.js') }}"></script>
