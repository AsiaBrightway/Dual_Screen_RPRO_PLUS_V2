        ...
        <div class="home-content">
            <div class="row pb-3 align-items-center" style="color:#512DA8; font-weight:bold">
                ...
                <div class="col" style="text-align: right">
                    <a href="{{ route('stockControl#stock_purchase#purchaseListPage') }}"><button
                            class="btn btn-warning customBtn-exit text-white" id="btn_Exit"><i class="fa-solid fa-circle-left"
                ...
                <div class="success-card">      
                    ...
                    <div class="text-content">
                        ...
                        <p class="success-desc">
                            Purchase record was updated successfully.
                        </p>
                    </div>
