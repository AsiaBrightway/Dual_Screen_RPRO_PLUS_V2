...
<style>
    ...
    #sales_report_list_by_default th:nth-child(2),
    #sales_report_list_by_default td:nth-child(2) {
        white-space: normal !important;
        word-wrap: break-word;
        width: 150px !important;
    }

    #sales_report_list_by_default th:nth-child(3),
    #sales_report_list_by_default td:nth-child(3) {
        white-space: normal !important;
        word-wrap: break-word;
    ...
    <div class="home-content" style="margin-left: 20px">
        ...
        <div class="stock_out_report_container row">
            ...
            <div class="col-9 sale-report-right">
                <div class="sales_table p-3" style="height: calc(100% - 110px);">
                ...
                <div class="sale_total_div row" style="margin-left: 0px; margin-right: 0px;">
