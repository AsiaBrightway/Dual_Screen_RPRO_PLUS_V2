...
@section('content')
        ...
        <div class="home-content">
            <div class="row pb-3 align-items-center" style="color:#512DA8; font-weight:bold">
                ...
                <div class="col-12 col-md-5 text-md-end text-start mt-3 mt-md-0">
                    ...
                    <button type="submit" form="tableCreateForm" class="btn btn-primary customBtn-save ms-1 mt-0"><i
            ...
            <div id="table_info_label" class="row align-items-center bg-white">
                <div class="col-10">
                    <label><i class="fa-solid fa-circle-half-stroke" style="padding-left:5px; padding-right: 12px"></i>Table
                        Info</label>
                </div>
            ...
            <div class="table_info_container shadow-sm">
                <form action="{{ route('table#create') }}" method="POST" id="tableCreateForm">
                    @csrf
                    <div class="row mb-3 justify-content-center">
                        <div class="col-2 table-label">
                            <label class="col-form-label">Table Name <span style="color: red">*</span></label>
                        </div>
                        <div class="col-3 table-text">
                    ...
                    <div class="row mb-3 justify-content-center">
                        <div class="col-2 table-label">
                            <label class="col-form-label">Floor <span style="color: red">*</span></label>
                        </div>
                        <div class="col-3 table-text">
            ...
            <div id="table_list_label" class="row align-items-center bg-white">
                <div class="col-10">
                    <label><i class="fa-solid fa-table-list" style="padding-left:5px; padding-right: 12px"></i>Table
                        Lists</label>
                </div>
                <div class="col-2" style="text-align: right">
                    <i class="bx bxs-chevron-down arrow"></i>
            ...
            <div class="table_list_container shadow-sm">
                        ...
                        @if (count($tables) != 0)
                            ...
                            @foreach ($tables as $table)
                                <tr>
                                    ...
                                    <td>{{ $table['table_other_name'] }}</td>
                                    <td>{{ $table['floor_name'] }}</td>
                                    @if ($table['table_is_discontinued'] == 0)
                                        <td><input class="form-check-input" type="checkbox" onclick="return false;"></td>
                                    @elseif ($table['table_is_discontinued'] == 1)
                                        <td><input class="form-check-input" type="checkbox" checked onclick="return false;">
                                        </td>
                                    @endif
                                    <td><a data-table_id="{{ $table['table_id'] }}"
                                            data-table_name="{{ $table['table_name'] }}"
                                            data-other_name="{{ $table['table_other_name'] }}"
                                            data-floor_id="{{ $table['floor_id'] }}"
                                            data-is_discontinued="{{ $table['table_is_discontinued'] }}"
                                            data-bs-toggle="modal" data-bs-target="#edit_table_modal"
                                            class="edit_table_modal_dialog"><i class="fa-solid fa-pen"
                                                style="color: blue; cursor: pointer;"></i></a></td>
                                    <td><a data-table_id="{{ $table['table_id'] }}"
                                            data-table_name="{{ $table['table_name'] }}" data-bs-toggle="modal"
                                            data-bs-target="#delete_table_modal" class="delete_table_modal_dialog"><i
                ...
                <!--Edit Table Modal -->
                <div class="modal fade" id="edit_table_modal" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="margin-left: 20px; margin-right:20px">
                                <form action="{{ route('table#update') }}" method="POST" id="tableEditModalForm">
                                    @csrf
                                    <input type="text" name="edit_table_id" id="edit_table_id" hidden>
                                    <div class="row mb-3 mt-3">
                                        <div class="col-5">
                                            <label class="form-label">Table Name <span style="color: red">*</span></label>
                                        </div>
                                        <div class="col">
                                            <input class="form-control" type="text" name="edit_table_name"
                                                id="edit_table_name">
                                        </div>
                                    </div>
                                    <div class="row mb-3 mt-3">
                                    ...
                                    <div class="row mb-3 mt-3">
                                        <div class="col-5">
                                            <label class="form-label">Floor <span style="color: red">*</span></label>
                                        </div>
                                        <div class="col">
                                            <select class="form-select" id="edit_floor" name="edit_floor">
                                                @if (count($floors) != 0)
                                                    @foreach ($floors as $floor)
                                                        <option value={{ $floor['floor_id'] }}>
                                                            {{ $floor['floor_name'] }}</option>
                            ...
                            <div class="modal-footer" style="margin-right: 20px">
                                <input type="submit" class="btn custom_btn" value="Update" form="tableEditModalForm">
                            </div>
                        </div>
                    </div>
                </div>
                <!--Delete Table Modal -->
                <div class="modal fade" id="delete_table_modal" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        {{-- <div class="modal-content">
                            <div class="modal-header text-center" style="background-color: #512DA8">
                            ...
                            <div class="modal-body" style="margin-left: 20px; margin-right:20px">
                                <form action="{{ route('table#delete') }}" method="POST" id="tableDeleteModalForm">
                                    @csrf
                                    <input type="text" name="delete_table_id" id="delete_table_id" hidden>
                            ...
                            <div class="modal-footer" style="margin-right: 20px">
                                <input type="submit" class="btn btn-danger" value="Delete" form="tableDeleteModalForm">
                            </div>
                        </div> --}}
                        <div class="success-card" style="padding-bottom: 1.5rem;">      
                            ...
                            <form action="{{ route('table#delete') }}" method="POST" id="tableDeleteModalForm">
                                ...
                                <div class="d-flex justify-content-center mt-3">
                                    <button type="submit" form="tableDeleteModalForm" class="btn btn-danger px-4">Delete</button>
                                </div>           
                            </form>
    ...
    <script src="{{ asset('script/table_script.js') }}"></script>
