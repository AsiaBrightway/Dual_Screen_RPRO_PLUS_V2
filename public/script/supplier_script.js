...
let supplier_info_container = document.querySelector(
    ".supplier_info_container"
);
if (localStorage.getItem("showSupplierInfoContainer")) {
    supplier_info_container.classList.add("show_container");
}

let supplier_list_container = document.querySelector(
    ".supplier_list_container"
);
if (localStorage.getItem("showSupplierListContainer")) {
    supplier_list_container.classList.add("show_container");
}
...
supplier_info_label.addEventListener("click", (e) => {
    ...
    if (supplier_info_container.classList.contains("show_container")) {
        localStorage.setItem("showSupplierInfoContainer", "true");
    } else {
        localStorage.removeItem("showSupplierInfoContainer");
    }
});
...
supplier_list_label.addEventListener("click", (e) => {
    ...
    if (supplier_list_container.classList.contains("show_container")) {
        localStorage.setItem("showSupplierListContainer", "true");
    } else {
        localStorage.removeItem("showSupplierListContainer");
    }
});
