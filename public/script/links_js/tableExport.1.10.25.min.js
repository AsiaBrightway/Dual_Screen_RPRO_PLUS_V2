        ...
        if ("csv" === a.type || "tsv" === a.type || "txt" === a.type) {
            ...
            if (!0 === a.pdfmake.enabled) {
                ...
                d(B).filter(function() { return I(d(this)) }).each(function() {
                    ...
                    U.content.push({
                        table: { headerRows: r.length ? r.length : null, widths: c, body: e },
                        layout: {
                            layout: "noBorders",
                            ...
                            fillColor: function(b, c, d) { return 0 === b % 2 ? a.pdfmake.docDefinition.styles.alternateRow.fillColor : null }
                        },
